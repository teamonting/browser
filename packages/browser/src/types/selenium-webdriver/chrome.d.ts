declare module 'selenium-webdriver/chrome.js' {
  ...
  // chrome.ServiceBuilder extends chromium.ServiceBuilder extends remote.DriverService.Builder.
  ...
  // chrome.Options extends chromium.Options extends Capabilities.
  class Options {
